...
import projectRoutes from './app/project/project.routes.js'
...
const upload = multer({
	...
	fileFilter: (req, file, cb) => {
		const fileTypes = /webp|jpeg|jpg|png|gif/
...
async function main() {
	...
	const sslOptions = {
		key: fs.readFileSync(
			'../../../etc/letsencrypt/live/backend.investkchr.ru/privkey.pem'
		),
		cert: fs.readFileSync(
			'../../../etc/letsencrypt/live/backend.investkchr.ru/fullchain.pem'
		)
	}
